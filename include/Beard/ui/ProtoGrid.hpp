/**
@file ui/ProtoGrid.hpp
@brief Prototype grid widget.

@author Tim Howard
@copyright 2014 Tim Howard under the MIT license;
see @ref index or the accompanying LICENSE file for full text.
*/

#ifndef BEARD_UI_PROTOGRID_HPP_
#define BEARD_UI_PROTOGRID_HPP_

...
enum class CapFlag : unsigned;
enum class CapNumber : unsigned;
enum class CapString : unsigned;
...
/**
	...
	@sa tty::TerminalInfo
*/
using CapFlagValue = bool;

// TODO: As specified in the terminfo header, "other negative values
// are illegal". Does this apply to capability numbers also?
// <term.h> has them signed.
/**
	CapNumber value.

	@sa tty::TerminalInfo
*/
using CapNumberValue = signed;
...
/**
	...
	@sa tty::TerminalInfo
*/
using CapStringValue = String;

/**
	Various capability constants.
*/
enum : signed {
	/**
		CapNumber is not supported.
	*/
	CAP_NUMBER_NOT_SUPPORTED = -1
};
